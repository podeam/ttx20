...
def get_line_info(n, line_index):
    ...
    Returns:
    str: A JSON formatted string with the requested line information.
    """
    ...
    timestamps = flow_series.index.to_pydatetime()  # Convert pandas DatetimeIndex to list of datetime objects
    ...
    line_info = {
        ...
        "timestamps": timestamps_str  # Relative timestamps as ISO 8601 strings
    }
