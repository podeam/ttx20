...
const LinksLayerAttack = ({ view, type, side, displaybox }) => {
  ...
  useEffect(() => {
    ...
    const linksAttackable = ['relation/6886400+2', 'relation/8185455+2'];
    ...
    fetch(url)
      ...
      .then((response) => {
        ...
        links1.forEach((item) => {
          ...
          //if (match && (item.Link == 'relation/8185455+2' || item.Link == 'relation/6886400+2')) {
          if (match && item.Link !== 'TYNDP2020_33' && item.Link !== 'relation/3392010+2 info' && item.Link !== "relation/8184631+2") {
          ...
          if (!view.getSource(sourceId)) {
            ...
            if(name2 == linksAttackable[0] || name2 == linksAttackable[1]) { color = '#0bb6e0'; }
            else{ color = '#958382'; }
            // Add line layer
            view.addLayer({
              id: lineId,
            ...
            if(name2 == linksAttackable[0] || name2 == linksAttackable[1]) {
...
export default LinksLayerAttack;
